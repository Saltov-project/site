...
// tokens
  ...
  $sidebars = array(
   ...
   'default' => array(
      ...
      'description' => __("Это стандартный вид боковой панели  на 2 или 3  колонке. Если нет активных виджетов,будет отображаться тема по умолчанию.", THEME_NS)
    ),
    
    'secondary' =>  array(
      'name' => __('Secondary Widget Area',THEME_NS),
      'id' => 'secondary-widget-area',
      'description' => __("Эта боковая панель активна только  при установке на 3 колонке.", THEME_NS)
    ),
    
    'top' => array(
      'name' => __('Top Widget Area',THEME_NS),
      'id' => 'top-widget-area',
      'description' => __("Эта боковая панель отображается над основным содержанием.", THEME_NS)
    ),
    
    'bottom' => array(
      'name' => __('Bottom Widget Area',THEME_NS),
      'id' => 'bottom-widget-area',
      'description' => __("Эта боковая панель отображается под основным содержанием.", THEME_NS)
    ),
    
    'footer' => array(
      'name' => __('First Footer Widget Area',THEME_NS),
      'id' => 'first-footer-widget-area',
      'description' => __("Первая нижняя часть виджета. Вы можете добавить текстовый виджет для пользовательского текста.", THEME_NS) 
    ),
    
    'footer2' => array(
      'name' => __('Second Footer Widget Area',THEME_NS),
      'id' => 'second-footer-widget-area',
      'description' => __("Вторая нижняя часть виджета.", THEME_NS) 
    ),
    
    'footer3' => array(
      'name' => __('Third Footer Widget Area',THEME_NS),
      'id' => 'third-footer-widget-area',
      'description' => __("Третья нижняя часть виджета.", THEME_NS) 
    ),
    
    'footer4' => array(
      'name' => __('Fourth Footer Widget Area',THEME_NS),
      'id' => 'fourth-footer-widget-area',
      'description' => __("Четвёртая нижняя часть виджета.", THEME_NS) 
    ),
        ...
        if ($sidebar) {
            ...
            for($i = 0; $i < count($blocks); $i++){
                ...
                switch($block) {
                    ...
                    break;
                    case 'categories':
                        echo art_get_block( __('Категории', THEME_NS), '<ul>'.wp_list_categories('show_count=1&title_li=&echo=0').'</ul>');
                    break;
                    case 'blogroll':
                        echo art_get_block( __('Ссылки', THEME_NS), '<a href="http://www.ipkvesti-spb.ru/">ipkvesti-spb.ru</a>');
